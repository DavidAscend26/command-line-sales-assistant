import type { Deal, KbSnippet } from "../core/types";
...
export const DEALS: Deal[] = [
  {
    ...
    nextStep:
      "Ask for security review timeline and offer a 20-min call with our security POC to unblock.",
    notes: [
  ...
  },
  {
    ...
    nextStep:
      "Evaluate discount request against pricing exception policy and seek approval if needed.",
    notes: [
...
export const KB: KbSnippet[] = [
  {
    id: "kb-soc2",
    title: "SOC 2 Type II Report (Customer Access)",
    body:
      "We maintain an active SOC 2 Type II report. Customers can request access via the Trust Portal. " +
  ...
  },
  {
    ...
    body:
      "Discount guidance: Standard discount up to 10% can be approved by Sales Manager. " +
  ...
  },
  {
    ...
    body:
      "Security review support: Provide SOC2, security FAQ, and DPA. Typical customer security review completes in 5–15 business days " +
  ...
  },
  {
    ...
    body:
      "We offer a standard DPA for customers. Legal review is supported through the standard contract workflow. " +
  ...
  },
  {
    ...
    body:
      "SSO is supported via SAML 2.0 for Enterprise plans. Provide setup instructions and confirm the customer's IdP (Okta, Azure AD, etc.).",
  ...
  },
  {
    ...
    body:
      "Default hosting region is US. EU hosting is available for Enterprise customers upon request. " +
